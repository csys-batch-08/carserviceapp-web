...
<link rel="stylesheet" type="text/css"
	href="assets/css/searchUserFour.css"></link>
</head>
<body>
	<div class="topnavbar">
		<div class="heading">
	...
	<div class="addmorebtns">
		<a href="pickupform"><button class="btn btn-dark">Add
				More Services</button></a> <a href="searchUserFive.jsp"><button
				class="btn btn-dark">No Thanks</button></a> <a href="searchUserFive.jsp"><button
				class="btn btn-dark">Go For Service</button></a>
	</div>
</body>
</html>