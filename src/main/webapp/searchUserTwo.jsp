...
<link rel="stylesheet" type="text/css" href="assets/css/searchUserTwo.css"/>
</head>
<body>
	<div class="topnavbar">
		<div class="heading">
			...
			<div class="register">
				...
				<div class="mb-0 mt-1">
					<label for="centerid" class="form-label"><strong>Center
						...
						name="centerid" class="form-control" id="centerid"
				...
				<div class="form-check mb-1">
					<input class="form-check-input" type="checkbox" id="myCheck"
						...
						href="termsAndPrivacy.jsp" id="termsprivacy">Terms &
							Privacy</a>.
					</label>
